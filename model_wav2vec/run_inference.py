...
def inference_checkpoint(model_path, manifest_path):
    ...
    # 2. Подготавливаем DataLoader с воркерами
    ...
    submission_path = root_path + "/submission/submission_wav2vec.jsonl"
...
if __name__ == "__main__":
    ...
    # model_path = root_path + 'model_wav2vec/models/checkpoint-59740_wer_0.3328_cer_0.0786/'
    model_path = 'ZFTurbo/facebook_wav2vec2_xls_r_300m_lingala_shona'
    inference_checkpoint(model_path, manifest_path)


"""
checkpoint-59740_wer_0.3328_cer_0.0786 WER: 0.3250 CER: 0.0778
averaged_checkpoint WER: 0.3250 CER: 0.0776
"""