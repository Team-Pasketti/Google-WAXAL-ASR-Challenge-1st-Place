...
class AudioBatchDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # Возвращаем уже полностью готовый батч данных
        return {
            "audios": audios,
            "chunks": chunks,
            "texts": texts,
...
if __name__ == "__main__":
    ...
    # model_path = root_path + 'model_qwen3_asr/models/checkpoint-5000_wer_35.4641_cer_8.8006/'
    model_path = 'ZFTurbo/Qwen3-ASR_lingala_shona'
    inference_checkpoint(
        model_path,
        manifest_path=manifest_path,
        subm_name="submission_qwen.jsonl",
    )
