...
def inference_checkpoint(model_path, manifest_path):
    ...
    with torch.inference_mode():
        ...
        for batch_data in pbar:
            ...
            # Отсекаем промпт из сгенерированной последовательности
    ...
    # WRITE SUBMISSION
    # =========================
    submission_path = root_path + "/submission/submission_ibm_granite.jsonl"
...
if __name__ == "__main__":
    ...
    # model_path = root_path + 'model_ibm_granite/models/checkpoint-37340_wer_0.4243_cer_0.1357/'
    model_path = "ZFTurbo/ibm_granite_speech_4.1_2b_lingala_shona"
    inference_checkpoint(model_path, manifest_path)


"""
checkpoint-37340_wer_0.4243_cer_0.1357 (Beam: 3): WER: 0.4265 CER: 0.1298
"""